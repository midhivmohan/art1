...
<div class="u-clearfix u-form-spacing-7 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 3px;">
     ...
     <div class="u-form-group u-form-name ">
      ...
      <input type="text" class="u-input u-input-rectangle u-white form-control" name="uname" placeholder="Username"required autocomplete="on|off">
		   ...
		   <input type="email" name="uemail" class=" u-input u-input-rectangle u-white form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="Email" required autocomplete="on|off">
  ...
  <div class="u-form-group u-form-partition-factor-2 u-form-phone u-form-group-4">
   ...
   <input type="phone"  placeholder="Phone" name="phone" class=" u-input u-input-rectangle u-white form-control"required pattern="[789][0-9]{9}" title="Must Number Having 10 Digits"
   autocomplete="on|off" >
   ...
   <div class="u-form-group u-form-partition-factor-2 u-form-group-5">
       ...
       <input type="text" placeholder="place" name="txtplace" class=" u-input u-input-rectangle u-white form-control" required autocomplete="on|off">
    </div>
       <div class="u-form-group u-form-address">
              
            <textarea placeholder="address" rows="4" cols="50" id="address" name="addrss" class=" u-input u-input-rectangle u-white form-control" >
</textarea>
        </div>
 ...
 <input type="password"placeholder="password" name="txtpass" class=" u-input u-input-rectangle u-white form-control" >
