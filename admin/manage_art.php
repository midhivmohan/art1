...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				<form  name="myForm"action="" id="manage-art" onsubmit="return validateForm()" method="post">
					<input type="hidden" name="id" value="<?php echo isset($id) ? $id :'' ?>">
					<div class="form-group row">
						<div class="col-md-5">
							<label for="" class="control-label">Art Title</label>
							<input type="text" class="form-control" name="art_title" 
							value="<?php echo isset($art_title) ? $art_title :'' ?>" required>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-5">
					...
					<div class="form-group row">
						<div class="col-md-10">
							...
							<textarea name="art_description" id="art_description" class="form-control jqte" cols="30" rows="5" required>
							<?php echo isset($art_description) ? html_entity_decode($art_description) : '' ?></textarea>
						</div>
					</div>
