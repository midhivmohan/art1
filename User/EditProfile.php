...
position: relative;">
       ...
       <table>
       <tr><td>Name</td>
           <td><input type="text" name="name" class="form-control" required="" value="<?php echo $row[1] ?>"/></td>
        </tr>
         <tr><td>DOB</td>
           <td><input type="text" name="udate" class="form-control" required="" value="<?php echo $row[2] ?>"/></td>
        </tr>
         <tr><td>Place</td>
           <td><input type="text" name="txtplace" class="form-control" required="" value="<?php echo $row[5] ?>"/></td>
        </tr>
        <tr><td>Phone</td>
        ...
        <tr><td>Email</td>
            <td><input type="email" class="form-control" name="uemail" value="<?php echo $row[3] ?>"
...
<br/><br/>
<table> <tr><td></td><td>
<td><a href="editprofilecode.php?name=<?php echo $row["regis_id"];?>" >EDIT</TD>
